...
public class Sort {
    ...
    public static void array() {
        ...
        outputMassiv(massiv);
        System.out.println("Возрастающий массив: " + sortBubbleMas(massiv));
        outputMassiv(mergeDivideMas(massiv));
